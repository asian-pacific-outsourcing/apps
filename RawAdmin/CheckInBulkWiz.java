...
final class CheckInBulkWiz extends DlgProgress
	{
	...
	private void onStart(File file)
		...
		try
			...
			worker = new FileWorker(new CheckInParser(getLog()), file);
