...
/********************************************************************
* @(#)_RD.java	1.00 10/05/27
* Copyright (c) 2010 by Richard T. Salamone, Jr. All rights reserved.
*
* _RD: The entry point and main container frame for the
...
* @version 2.00 20110316 rts network version now subclasses ClientApp
*******************************************************/
...
//		table.addDispoEditor( Role.TQ.saveDispos());
		Dispo[] dispos = Role.TQ.saveDispos();
		table.setEditor(Dispo.class, new DispoRenderer(dispos), new DispoEditor(dispos));
...
//		table.setRowHeight( m_rowHeight );
	...
	public void ensureHaveWork()
		...
		if ( modeSelect.getPageCount() > 0 )
			return;
		SBDialog.showMsg( null, LAF.getDialogTitle("No work found"), "All pages are checked in.", 0 );
	...
	public static void main( String[] args )
		{
		SBProperties.load(_RD.class, "com/apo/apo.properties");
