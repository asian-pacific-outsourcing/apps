package com.apo.apps.caller.Tingler;
/********************************************************************
* @(#)_Tingler.java 1.00 20100728
* Copyright (c) 2010-2011 by Richard T. Salamone, Jr. All rights reserved.
*
* _Tingler: The entry point Tingler application.
*
...
public class _Tingler
	{
	private static long blowUp = 0; // SBDate.toTime("20101231  23:59");

	public static void main( String[] args )
		{
		SBProperties.load(_Tingler.class, "com/apo/apo.properties");
		LAF.initLAF(blowUp, true);
		Access.parseCmdLine(args);
		CallerApp.createAndShowGUI(Access.VO);
		}
	}
