package com.apo.apps.caller.AO;
/********************************************************************
* @(#)_AO.java 1.00 20100728
* Copyright (c) 2010 by Richard T. Salamone, Jr. All rights reserved.
*
* _AO: The entry point and main container frame for the
...
public class _AO
	...
	public static void main( String[] args )
		{
		SBProperties.load(_AO.class, "com/apo/apo.properties");
		LAF.initLAF(blowUp, true);
		Access.parseCmdLine(args);
		CallerApp.createAndShowGUI(Access.AO);
		}
	}
