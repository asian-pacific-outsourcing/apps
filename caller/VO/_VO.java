package com.apo.apps.caller.VO;
/********************************************************************
* @(#)_VO.java 1.00 20100728
* Copyright (c) 2010 by Richard T. Salamone, Jr. All rights reserved.
*
* _VO: The entry point and main container frame for the
...
public class _VO
	...
	public static void main( String[] args )
		{
		SBProperties.load(_VO.class, "com/apo/apo.properties");
